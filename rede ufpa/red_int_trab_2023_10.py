...
dss_file = r"G:\Meu Drive\Mestrado\Aulas\Materias Vigentes\redes eletricas inteligentes\Trabalhos\Trabalho Microrrede OpenDSS\trab_microrrede\rede ufpa\RedeDeDistribuicaoUFPA_util"
...
for i in range(0, n):
    ...
    for ii in range(0, dss.loads_count()):
        ...
        dss.loads_write_kw(pot_ativa * 1.1)
        dss.loads_write_kvar(pot_reativa * 1.1)
        dss.loads_next()
    ####################################################################################################################
...
plt.grid(True)
plt.savefig(r"G:\Meu Drive\Mestrado\Aulas\Materias Vigentes\redes eletricas inteligentes\Trabalhos\Trabalho Microrrede OpenDSS\trab_microrrede\rede ufpa\resultados\three-phase active power.svg")
plt.show()
...
plt.grid(True)
plt.ylim(0.9, 1.1)
plt.savefig(r"G:\Meu Drive\Mestrado\Aulas\Materias Vigentes\redes eletricas inteligentes\Trabalhos\Trabalho Microrrede OpenDSS\trab_microrrede\rede ufpa\resultados\lower voltage.svg")
plt.show()
...
plt.grid(True)
plt.savefig(r"G:\Meu Drive\Mestrado\Aulas\Materias Vigentes\redes eletricas inteligentes\Trabalhos\Trabalho Microrrede OpenDSS\trab_microrrede\rede ufpa\resultados\active losses.svg")
plt.show()
########################################################################################################################
print('terminei')
